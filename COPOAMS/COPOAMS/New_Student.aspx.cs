    ...
    public partial class New_Student : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                String sql = "insert into STUDENT(BATCH, USN, STUDENT_NAME) values('" + batch.SelectedItem + "','" + usn.Text + "','" + student_name.Text + "')";
                SqlCommand cmd = new SqlCommand(sql, con);
                cmd.ExecuteNonQuery();
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Student added successfully.');window.location ='" + "New_Student.aspx" + "';", true);
            }
