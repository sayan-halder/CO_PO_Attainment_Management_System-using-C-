<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calculate_CO_Values.aspx.cs" Inherits="COPOAMS.Calculate_CO_Values" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CALCULATE COs VALUES</title>
    <link href="CSS/Calculate_CO_Values.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div>
        ...
        <center><asp:Label ID="Label1" runat="server" Text="CALCULATE COs VALUES"></asp:Label></center>
        <br />
        <br />
        ...
        <center><asp:Label ID="Label5" runat="server" Text="CO:"></asp:Label>&emsp;
