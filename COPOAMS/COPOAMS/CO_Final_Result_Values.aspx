<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CO_Final_Result_Values.aspx.cs" Inherits="COPOAMS.CO_Final_Result_Values" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ATTAINMENT OF COs</title>
    <link href="CSS/CO_Final_Result_Values.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div>
        ...
        <center><asp:Label ID="Label1" runat="server" Text="ATTAINMENT OF COs"></asp:Label></center>
        <br />
        <br />
