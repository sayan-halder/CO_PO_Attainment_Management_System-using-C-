...
<body>
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="column1">
                <asp:Image ID="Image1" runat="server" Height="664px" 
                    ImageUrl="~/Images/bmsit.jpg" Width="100%" />
            </div>
            <div class="column2">
                <asp:Image ID="Image2" runat="server" Height="109px" 
                    ImageUrl="~/Images/bmslogo.png" Width="100%" />
                <br />
                <br />
