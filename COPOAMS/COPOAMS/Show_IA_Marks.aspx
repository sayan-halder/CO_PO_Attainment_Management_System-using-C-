<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show_IA_Marks.aspx.cs" Inherits="COPOAMS.Show_IA_Marks" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SHOW INTERNAL ASSESSMENT MARKS</title>
    <link href="CSS/Show_IA_Marks.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
    <div>
        <center><asp:Label ID="Label1" runat="server" Text="SHOW INTERNAL ASSESSMENT MARKS"></asp:Label></center>
        <br />
