<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show_IA_COs.aspx.cs" Inherits="COPOAMS.Show_IA_COs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SHOW INTERNAL ASSESSMENT COs VALUES</title>
    <link href="CSS/Show_IA_COs.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div>
        <br />
        <br />
        <center><asp:Label ID="Label1" runat="server" Text="SHOW INTERNAL ASSESSMENT COs VALUES"></asp:Label></center>
        <br />
        <br />
        ...
        <center><asp:Label ID="Label5" runat="server" Text="IA NUMBER:"></asp:Label>&emsp;
        ...
        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="SHOW" Height="30px" Width="220px" /></center>
        <br />
        <br />
