<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="External_Exam_Result.aspx.cs" Inherits="COPOAMS.External_Marks_Result" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>EXTERNAL EXAM RESULT</title>
    <link href="CSS/External_Exam_Result.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div>
        ...
        <center><asp:Label ID="Label1" runat="server" Text="EXTERNAL EXAM RESULT"></asp:Label></center>
        <br />
        <br />
