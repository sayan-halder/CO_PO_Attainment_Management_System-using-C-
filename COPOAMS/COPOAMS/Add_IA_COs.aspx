<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_IA_COs.aspx.cs" Inherits="COPOAMS.Add_IA_COs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ADD IA COs</title>
    <link href="CSS/Add_IA_COs.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div>
        <br />
        <br />
        <center><asp:Label ID="Label1" runat="server" Text="ADD INTERNAL ASSESSMENT COs VALUES"></asp:Label></center>
        <br />
        <br />
        ...
        <center><asp:Label ID="Label5" runat="server" Text="IA NUMBER:"></asp:Label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
        <asp:DropDownList ID="ia_number" runat="server" Width="310px">
        ...
        <center>
        <asp:Label ID="Label6" runat="server" Text="Q1"></asp:Label>&emsp;&emsp;
        ...
        <asp:Label ID="Label7" runat="server" Text="Q5"></asp:Label>&emsp;&emsp;
        ...
        <center>
        <asp:Label ID="Label8" runat="server" Text="Q2"></asp:Label>&emsp;&emsp;
        ...
        <asp:Label ID="Label9" runat="server" Text="Q6"></asp:Label>&emsp;&emsp;
        ...
        <center>
        <asp:Label ID="Label10" runat="server" Text="Q3"></asp:Label>&emsp;&emsp;
        ...
        <asp:Label ID="Label11" runat="server" Text="Q7"></asp:Label>&emsp;&emsp;
        ...
        <center>
        <asp:Label ID="Label12" runat="server" Text="Q4"></asp:Label>&emsp;&emsp;
        ...
        <asp:Label ID="Label13" runat="server" Text="Q8"></asp:Label>&emsp;&emsp;
        ...
        <center>
        <asp:Label ID="Label14" runat="server" Text="ASSINGMENT"></asp:Label>&emsp;&emsp;
        ...
        <center><asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="SUBMIT" Height="30px" Width="220px" />&emsp;&emsp;
        <asp:Button ID="Button2" runat="server" onclick="Button2_Click" Text="CLEAR ALL FIELDS" Height="30px" Width="220px" />&emsp;&emsp;
